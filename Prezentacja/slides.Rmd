...
## Zbiór danych airquality (CZY TO POTRZEBNE?)
```{r missing_data_vis_2, dev.args=list(bg='transparent'), fig.align='center', echo=FALSE, results='hide'}
...
```{r missing_data_vis_3_plots, dev.args=list(bg='transparent'), fig.align='center', echo=FALSE}
...
## Wizualizacja danych imputowanych (DO POPRAWY)
```{r imputed_data_vis1, dev.args=list(bg='transparent'), fig.height=4, fig.align='center'}
