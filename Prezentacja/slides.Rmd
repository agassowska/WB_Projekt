...
## Wywołanie metody PCA na imputowanych danych  
```{r imputed_data_vis2}
...
```{r uncertainity, fig.show='hold', fig.align='center'}
mi <- MIPCA(airquality, scale = TRUE, ncp = 2)
plot.MIPCA(mi, choice = "var")
plot.MIPCA(mi, choice = "dim")
```
